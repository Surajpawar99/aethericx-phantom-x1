/* NITRO V15 — Apple-style scroll film
...
function devPlaceholder(msg) {
  ...
  const draw = () => {
    ...
    g.addColorStop(1, "#080608");
    ctx.fillStyle = g;
    ctx.fillRect(0, 0, canvas.width, canvas.height);
    ctx.fillStyle = "rgba(220,30,50,0.85)";
...
loadManifest()
  ...
  .catch(() => devPlaceholder("frames not built yet — run scripts/build_frames.py"));
